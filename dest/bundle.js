...
exports.init = exports.handleEvent = undefined;

var _view = __webpack_require__(3);

var sView = _interopRequireWildcard(_view);

var _model = __webpack_require__(1);

var sModel = _interopRequireWildcard(_model);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var handleEvent = void 0,
    init = void 0,
    addEvent = void 0;

exports.handleEvent = handleEvent = function handleEvent(type, ev) {
...
exports.getData = getData = function getData() {
    return data;
};

exports.sub = sub = function sub(fn) {
    typeof fn == 'function' && obs.push(fn);
};
exports.pub = pub = function pub(data) {
...
exports.addNum = addNum = function addNum() {
    data.number++;
    pub(getData());
};
...
var sController = _interopRequireWildcard(_controller);
...
exports.init = exports.render = undefined;
...
exports.init = init = function init(data) {
    ...
    if (container.appendChild(wrapper)) {
        ...
        document.getElementById('seeBtn').addEventListener('click', function (ev) {
            sController.handleEvent('click', ev);
            ev.stopPropagation();
        });
    };
